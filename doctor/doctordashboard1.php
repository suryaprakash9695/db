        ...
        <div class="row mt-4">
            <div class="item features-image сol-12 col-md-6 col-lg-6">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/ai_tools.jpeg" alt="" title="">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5" style="color:#ea0faa;"><strong>AI Tools</strong></h5>
                            <p class="mbr-text mbr-fonts-style mt-3 display-7">
                                Leverage the power of AI to detect and predict diseases. Let the latest AI technology assist you in providing the right diagnosis to your patients.
                            </p>
                    </div>
                    <div class="mbr-section-btn item-footer mt-2"><a href="aiTools.php" class="btn item-btn btn-primary display-7">Explore Now &gt;</a></div>
                </div>
            </div>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-6">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/consult-626x417.jpeg" alt="" title="" data-slide-to="1">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5" style="color:#ea0faa;"><strong>Patient Dashboard</strong></h5>
                    
                        <p class="mbr-text mbr-fonts-style mt-3 display-7">
                            View all the medical records of your patients under a single dashboard, and add prescriptions for timely information and treatment.
                        </p>
                    </div>
                    <div class="mbr-section-btn item-footer mt-2"><a href="patientList.php" class="btn item-btn btn-primary display-7">Start Now &gt;</a></div>
                </div>
            </div>
        </div>
    </div>
...
<section class="footer3 cid-s48P1Icc8J" once="footers" id="footer3-i"><div class="container">
    <div class="media-container-row align-center mbr-white">
        ...
        <div class="row row-copirayt">
            <p class="mbr-text mb-0 mbr-fonts-style mbr-white align-center display-7">Made With ❤️ by Team ENIGMA&bsp;</p>
        </div>
    </div>
</div>
</section>
