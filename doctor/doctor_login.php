...
if (isset($_SESSION['LAST_ACTIVITY'])) {
    ...
    if ($elapsed_time > $timeout_duration) {
        ...
        header("Location: doctor_login.php"); // Updated path
        exit();
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $pass = $_POST['password'];
    $role = 'doctor'; // Set role as doctor for this page
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                        <li class="nav-item">
                            <a class="nav-link link text-black display-4" href="../index.php#features1-n">Home</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="col-12 col-lg-6">
                <div class="text-wrapper align-items-right">
                    <h3 class="mbr-section-title mbr-fonts-style display-5">
                        <strong style="font-family: 'Dancing Script', cursive;">Doctor Login</strong>
                    </h3>
                    <div>
                        <form method="post">
