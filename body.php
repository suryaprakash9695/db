        ...
        <div class="row mt-4">
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/image/images.jpeg" alt="" title="">
                    </div>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/tracker_img.jpeg" alt="" title="">
                    </div>
                    <div class="item-content">
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/body.png" alt="" title="">
                    </div>
                    <div class="item-content">
                    ...
                    <div class="mbr-section-btn item-footer mt-2"><a href="bodyspace/index.php" class="btn item-btn btn-primary display-7">Explore Now &gt;</a></div>
                </div>
            </div>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/image/240_F_281427785_gfahY8bX4VYCGo6jlfO8St38wS9cJQop.jpg" alt="" title="">
                    </div>
                    <div class="item-content">
                    ...
                    <div class="mbr-section-btn item-footer mt-2"><a href="know-your-medicine/medicine.php" class="btn item-btn btn-primary display-7">Explore Now &gt;</a></div>
                </div>
            </div>
        </div>
    </div>
