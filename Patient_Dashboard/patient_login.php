...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($emailResult->num_rows > 0) {
        echo "<h3 style='color:red; text-align:center; margin-top:20px;'>Email already exists. 
              <a href='patient_login.php'>Go back to Login Page</a></h3>";
        exit();
    }
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                        ...
                        <li class="nav-item">
                            <a class="nav-link link text-black display-4" href="patient_dashboard.php">Dashboard</a>
                        </li>
                    </ul>

                    <div class="navbar-buttons mbr-section-btn">
                        <a class="btn btn-primary display-4" href="patient_login.php">
                            Log In/Sign Up
                        </a>
                    </div>
                </div>
        ...
        <div class="container login">
            ...
            <div class="col-12 col-lg-6">
                <div class="text-wrapper align-items-right">
                    ...
                    <div>
                        <form method="POST" action="patient_signup.php" id="signupForm">
                            ...
                            <div class="form-floating form-field-login" style="text-align:center; margin:15px;">
                                <a href="patient_login.php">Already a member? Click here to Login.</a>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="media-container-row align-center mbr-white">
                ...
                <div class="row row-copirayt">
                    <p class="mbr-text mb-0 mbr-fonts-style mbr-white align-center display-7">Made With ❤️ by Team ENIGMA&nbsp;</
