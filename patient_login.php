        ...
        <div class="col-lg-5 col-md-10">
            <div class="card shadow" style="padding: 2.5rem 1.5rem; min-width: 380px;">
                <div class="card-header text-center" style="padding: 1.2rem 0;">
                    <h3 style="font-size: 2.2rem; margin-bottom: 0; font-family: 'Dancing Script', cursive; color: #e71f68;">Patient Login</h3>
                </div>
                <div class="card-body">
                    <form>
                    ...
                    <div class="mt-4 text-center">
                        <a href="patient_signup.php" class="signup-link" style="font-size: 1.1rem;">Don't have an account? Sign up</a>
                    </div>
                </div>
            </div>
        </div>
