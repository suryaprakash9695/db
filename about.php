            ...
            <div class="row mb-5">
                <div class="col-lg-12" data-aos="fade-up">
                    <div class="about-content">
                        ...
                        <ul>
                            <li>Online medical consultations with expert doctors</li>
                            <li>Mental health support and professional counseling</li>
                            <li>Advanced physical health tracking and monitoring</li>
                            <li>Guided meditation and wellness programs</li>
                            <li>Comprehensive health education and resources</li>
                        </ul>
                    </div>
                </div>
            </div>
