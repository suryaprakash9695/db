...
<div class="container" style="margin-top: 60px;">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-7 d-none d-lg-block text-center">
            <img src="assets/images/login.jpg" alt="Doctor Login" class="img-fluid rounded shadow" style="max-width: 95%; min-height: 400px; object-fit: cover;">
        </div>
        <div class="col-lg-5 col-md-10">
            <div class="card shadow" style="padding: 2.5rem 1.5rem; min-width: 380px;">
                <div class="card-header text-center" style="padding: 1.2rem 0;">
                    <h3 style="font-size: 2.2rem; margin-bottom: 0; font-family: 'Dancing Script', cursive; color: #e71f68;">Doctor Login</h3>
                </div>
                <div class="card-body">
                    <form>
