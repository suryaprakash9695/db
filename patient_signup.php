        ...
        <div class="col-lg-5 col-md-10">
            <div class="card shadow" style="padding: 2.5rem 1.5rem; min-width: 380px;">
                <div class="card-header bg-primary text-white text-center" style="font-size: 2.2rem; padding: 1.2rem 0;">
                    <h3 style="font-size: 2.2rem; margin-bottom: 0;">Patient Signup Form</h3>
                </div>
                <div class="card-body">
                    <form>
                        ...
                        <button type="submit" class="btn btn-primary w-100" style="font-size: 1.3rem; padding: 0.85rem 0;">Sign Up</button>
                    </form>
                </div>
            </div>
        </div>
